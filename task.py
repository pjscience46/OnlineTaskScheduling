...
class Task:
    ...
    def __init__(self, w, p, d, c, speedup_model=None, status: Status = Status.BLOCKED, allocation=None, needed_time=None, starting_time=None, ):
        """
    ...
    def get_execution_time(self, nb_processors, speedup_model: Model = None):
        """
        ...
        if speedup_model is None:
            speedup_model = self.speedup_model
        return speedup_model.time(self, nb_processors) 

    def get_area(self, number_of_processors, speedup_model: Model = None):
    ...
    def get_p_max(self, P, speedup_model: Model = None):
    ...
    def allocate_processor_algo(self, P_num, mu, alpha,beta,gamma, speedup_model: Model = None, version = None):
    ...
    def get_minimum_execution_time(self, P, speedup_model: Model = None):
    ...
    def get_minimum_area(self, P, speedup_model: Model = None):
    ...
    def allocate_processor_Min_time(self, P, mu, speedup_model: Model = None):
    ...
    def allocate_processor_Min_area(self, P, mu, speedup_model: Model = None):
