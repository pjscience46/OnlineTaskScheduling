...
csv_file = r'C:\Thesis\Fresh pull\Onlineschedulingalgo_assorted_1\Results_mtpa\Heat_Maps\Amdahl\Generate_Avg_Max.csv'
data = pd.read_csv(csv_file)

# Define save directory
save_directory = r'C:\Thesis\Fresh pull\Onlineschedulingalgo_assorted_1\Results_mtpa\Contour_Plots\Amdahl'
...
def plot_contour_with_min(grid, title, cmap=custom_cmap_reversed):
    ...
    plt.annotate(f"Optimal value: {min_value}", (min_gamma, min_mu), textcoords="offset points", xytext=(-15,10), ha='center', fontsize=10, color='black', bbox=dict(facecolor='white', alpha=0.6))
